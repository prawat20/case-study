...
## CS1 status (2026-05-18)

- **Caselet 1 (Revolut Primacy) — shipped as a print-ready 28-page PDF.** Source at [`docs/cs1_caselet1_revolut.md`](docs/cs1_caselet1_revolut.md) (858 lines, structured verbatim per brief). Built via 4-stage research-first discipline: research → macro synthesis → ideation+scoring → submission. Polish round 2026-05-12 added a markdown→PDF build pipeline ([`docs/_build_pdf.py`](docs/_build_pdf.py)), 14 high-fidelity HTML phone mockups across 7 two-up grids, and an inline-SVG icon set. Section-level TL;DR callouts added 2026-05-14. Rendered deliverable: [`CS1_Caselet1_Revolut_Primacy.pdf`](CS1_Caselet1_Revolut_Primacy.pdf).
